...
export default function RandomJoke() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-slate-600 from-[#ffa500] to-[#ff6b6b] p-4">
      {/* Center the joke card within the screen */}
      <div className="rounded-2xl shadow-lg p-8 w-full bg-slate-400 [box-shadow:0px_0px_20px_black] max-w-md">
        {/* Header with title */}
        <h1 className="text-3xl font-bold mb-4 text-[#333]">
          😂 Random Joke 👈
        </h1>
        {/* Display the joke or a loading message */}
        <div className="bg-slate-200 rounded-lg p-6 mb-6 text-[#555] text-lg">
          {joke || "Loading..."}
        </div>
